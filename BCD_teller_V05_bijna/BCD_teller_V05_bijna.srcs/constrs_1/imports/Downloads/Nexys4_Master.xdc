...
#Bank = 15, Pin name = IO_L3P_T0_DQS_AD1P_15,				Sch name = rst
    set_property PACKAGE_PIN C12 [get_ports rst]                
        set_property IOSTANDARD LVCMOS33 [get_ports rst]
 
## Switches
#Bank = 34, Pin name = IO_L21P_T3_DQS_34,					Sch name = test
set_property PACKAGE_PIN U9 [get_ports {test}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {test}]
#Bank = 34, Pin name = IO_25_34,							Sch name = zero
set_property PACKAGE_PIN U8 [get_ports {zero}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {zero}]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = tel_rst
set_property PACKAGE_PIN R7 [get_ports {tel_rst}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {tel_rst}]
#Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = cnt_dwn
set_property PACKAGE_PIN R6 [get_ports {cnt_dwn}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cnt_dwn}]
